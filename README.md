...
Instead of using Pixels, the agents percieve the environment using simple hand-crafted features.
...
<img src="images/pgm_video.gif" alt="drawing" width="500"/>
...
<img src="images/dqn_video.gif" alt="drawing" width="500"/>
