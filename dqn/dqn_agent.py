"""Agent selecting the action according to the maximum value of the Q function."""
...
class Agent:
    ...
    def soft_update(self, local_model, target_model, tau):
        ...
        @param local_model (PyTorch model): model the weights will be copied from
        @param target_model (PyTorch model): model the weights will be copied to
